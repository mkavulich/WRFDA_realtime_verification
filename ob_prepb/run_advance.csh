...
set WRF_RUN_DIR = ${EXP_DIR_TOP}/${DA_METHOD}/advance/${DATE}
...
EOF
   ...
   if ( ! -e $EXP_DIR_TOP/${DA_METHOD}/${DATE}/wrfbdy_d01_${DATE} || \
        ! -e $EXP_DIR_TOP/${DA_METHOD}/${DATE}/wrfvar_output_d01_${DATE} ) then
   ...
   ln -sf $EXP_DIR_TOP/${DA_METHOD}/${DATE}/wrfvar_output_d01_${DATE} ./wrfinput_d01
   if ( ${MAX_DOM} == 2 ) then
