...
scp -p galaxy.mmm.ucar.edu:/mmmtmp/bresch/data/obs/obs.${OBS_DATE1} ${OBSPROC_RUN_DIR}
scp -p galaxy.mmm.ucar.edu:/mmmtmp/bresch/data/obs/obs.${DATE}      ${OBSPROC_RUN_DIR}
