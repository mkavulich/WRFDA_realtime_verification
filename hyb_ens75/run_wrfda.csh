...
# link VARBC related file
   ...
   if ( ! -e ${EXP_DIR_TOP}/${VARBC_PREV_DATE}/VARBC.out ) then
      ...
      ln -sf ${EXP_DIR_TOP}/${VARBC_PREV_DATE}/VARBC.out ./VARBC.in
   endif
 endif

   if ( ${FG_SOURCE} == 'cold' ) then
      set FG_FILE = wrfinput_d${domain_id}_${gdate[1]}_${gdate[2]}_mean
      if ( ! -e ${FG_FILE} ) then
         echo "ERROR in run_wrfda.csh : first guess ${FG_FILE} not found..." >> ${CSH_DIR}/job_${EXPT}.log
         exit 1
      endif
      ln -sf ${FG_FILE} fg
