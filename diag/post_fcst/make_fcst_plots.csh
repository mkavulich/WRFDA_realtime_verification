...
set GRAPHICS_RUN_DIR = /glade/scratch/hclin/CONUS/wrfda/postdir/${FCST_DIR}/${DATE}/webplot
set LOGS_RUN_DIR = $GRAPHICS_RUN_DIR
setenv WRF_DIR   /glade/scratch/hclin/CONUS/wrfda/expdir/rt/${FCST_DIR}
setenv POST_DIR  /glade/scratch/hclin/CONUS/wrfda/postdir/${FCST_DIR}
...
rsync -av ${GRAPHICS_RUN_DIR}/*_f${fhr3}_CONUS.png galaxy.mmm.ucar.edu:/web/htdocs/wrf/users/wrfda/rt_wrfda/conus15km/images/CONUS/hourly/${DATE}
